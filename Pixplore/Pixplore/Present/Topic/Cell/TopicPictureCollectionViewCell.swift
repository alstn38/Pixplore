//
//  TopicPictureCollectionViewCell.swift
//  Pixplore
//
...
final class TopicPictureCollectionViewCell: UICollectionViewCell {
    ...
    private func configureLayout() {
        topicPictureImageView.snp.makeConstraints {
